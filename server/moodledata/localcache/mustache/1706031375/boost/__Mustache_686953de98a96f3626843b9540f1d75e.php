...
class __Mustache_686953de98a96f3626843b9540f1d75e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'headeractions' => array($this, 'block8aecc957bb177aa97e049cb9c29ea165'),
...
';
    ...
    public function block8aecc957bb177aa97e049cb9c29ea165($context)
    {
        $indent = $buffer = '';
